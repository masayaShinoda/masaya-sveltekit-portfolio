...
<div class="content_page_container webdev_page_container">
	<div class="content">
		...
		<section class="webdev_projects_section">
				...
				<nav class="webdev_projects_section__top__btn_group">
					{#each Array.from(web_projects.map((project) => project.industry)).filter((x, i, a) => a.indexOf(x) == i) as industry, index}
						<a
							...
							class="section_top_btn btn_main btn_main__smaller"
						>
							{industry}
						</a>
					{/each}
			...
			<div class="webdev_projects_section__body">
				...
				{#each Array.from(web_projects.map((project) => project.industry)).filter((x, i, a) => a.indexOf(x) == i) as industry, index}
					<div id={encodeURI(industry)} class="webdev_projects_section__body__industry">
						{#each web_projects as project}
							{#if project.industry === industry}
								<!-- content here -->
								<article id={`${project.id}`} class="webdev_projects_section__body__item">
...
.webdev_top_section__left {
	padding: 4.25rem 0;
	border: 2px solid var(--clr_grey_shade_e);
	border-radius: 1rem;
	width: 42.5%;
	/* outline: 1px solid blue; */
}

[data-theme='dark'] .webdev_page_container .webdev_top_section__left {
...
[data-theme='dark'] .webdev_page_container .webdev_top_section__left>img {
...
[data-theme='dark'] .webdev_page_container .webdev_top_section__left>h1 {
	color: #fff;
}
...
[data-theme='dark'] .webdev_top_section__right p {
	color: var(--clr_light);
}
...
[data-theme='dark'] .webdev_page_container .webdev_projects_section__top {
	background-color: rgba(0, 0, 0, 0);
}
...
[data-theme='dark'] .content .webdev_projects_section__top>h2 {
	color: #fff;
}
...
.webdev_projects_section__top__line {
	...
	flex-grow: 1;
	height: 2px;
	background-color: var(--clr_grey_shade_d);
	margin: 0 1.5rem;
}

[data-theme='dark'] .content .webdev_projects_section__top__line {
...
@media screen and (max-width: 48em) {
	...
	[data-theme='dark'] .webdev_page_container .webdev_projects_section__body__item {
...
[data-theme='dark'] .webdev_projects_section__body__item .industry {
	color: var(--clr_greey_shade_c);
}
...
[data-theme='dark'] .webdev_projects_section__body__item .content_half__content {
	color: var(--clr_light);
}
...
.webdev_projects_section__body__item .content_half__content__tools>div {
	display: flex;
	justify-content: flex-start;
	align-items: center;
...
[data-theme='dark'] .webdev_projects_section__body__item .content_half__content__tools>div {
	/* width: fit-content; */
...
.webdev_projects_section__body__item .content_half__content__tools img {
	object-fit: contain;
	max-height: 2.5rem;
}

.webdev_projects_section__body__item .content_half__content__tools img:not(:last-of-type) {
	margin-right: 1rem;
}
