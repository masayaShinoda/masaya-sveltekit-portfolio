const projects = [
  {
    id: 'real-estate-group-website',
    name: 'Real Estate Group Website',
    industry: 'Real estate',
    overview: `A custom website for a Cambodia-based real estate and investment group. I built the platform with Django to provide a reliable, maintainable backend, leveraging its ORM, templating system, and admin interface so the team can easily manage listings, project updates, and content in-house. The frontend uses TailwindCSS for a clean, consistent design, while interactive components such as filtered property views and inquiry flows are powered by HTMX to keep the experience fast and straightforward without unnecessary complexity.`,
    responsibilities: `Fullstack Development & Secure Hosting on Linux VPS, DNS management.`,
    tools: ['HTML', 'CSS', 'Django', 'Figma'],
    duration: 'Eight weeks',
    link: 'https://huntergroup.asia/',
    image: '/images/mockups/mockup-huntergroup.png'
  },
  {
