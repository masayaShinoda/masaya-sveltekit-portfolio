...
<section class={styles.hero_container}>
	<div class={styles.hero_content}>
		<span>
			<h1>
				<span class={styles.subtitle}> Hi, I'm Masaya! </span>
				<span class={styles.title}> I help ideas achieve a quality online presence. </span>
			</h1>
